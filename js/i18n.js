...
const I18N = {
  es: {
    ...
    metaTitle: 'Quba — Tu compañero espiritual',
    metaDesc: 'Quba — Tu compañero espiritual islámico: Corán con tafsir, oración, Qibla, calendario hijri, quiz gamificado',
  },
  ar: {
    appName: 'قُبَّة',
    ...
    metaTitle: 'قُبَّة — رفيقك الروحي',
    metaDesc: 'قُبَّة — رفيقك الروحي الإسلامي: القرآن مع التفسير، الصلاة، القبلة، التقويم الهجري، اختبارات تفاعلية',
  ...
  en: {
    ...
    metaTitle: 'Quba — Your spiritual companion',
    metaDesc: 'Quba — Your Islamic spiritual companion: Quran with tafsir, prayer, Qibla, Hijri calendar, gamified quiz',
